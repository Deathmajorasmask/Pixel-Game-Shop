 ...
 * Generated at: 2022-01-04 13:01:34 UTC
...
//List<usuer> users = (List<usuer>)request.getAttribute("ShowUsers");
   List<products> prods = (List<products>)request.getAttribute(requestUP.KEY_ALL_Prods);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<!--surround the select box with a \"custom-select\" DIV element. Remember to set the width:-->\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("<div>\n");
      out.write("            <button type=\"button\" class=\"btn btn-success\" id=\"agrega\"  onclick=\"location.href='productoMN.jsp'\" >agregar producto </button>       \n");
      out.write("</div>\n");
      out.write("\n");
 int ida=0;     
      out.write("\n");
   ...
   int idp= prod.getIdprod();
      ...
      out.write("\" class=\"btn btn-success\">modificar</button>\n");
      out.write("                \n");
