...
<!--
<div class="custom-select" style="width:200px; padding: border-left-width:15px top: 15px">
  <select>
...
<br>
<form name="venta" method="POST" action="Venta?car=<%=carr.getIdCar()%>" >
    <div class="row">
        <div class="col-md-auto">
            <div>
                <img src="<%=carr.getPimg()%>" alt="..." class="img-thumbnail" style="margin-left: 50px" height="350" width="350">
            </div>
        </div>
...
<p>   <%=carr.getNombre()%></p>
<br>
<p>  descripcion   <%=carr.getDescri()%></p>
<br>
<p>  estado   <%=carr.getEst()%></p>
<div>
<br>
<p> tipo de pago <%=carr.getTP()%>  </p>
 </div>
        </div>
<br>
<div style="border-top-width: 15px; padding-top:20px; ">
        <div class="col col-lg-2" align="center">
         <p>  categoria  <%=carr.getCatego()%></p>
        </div>
        <div class="col col-lg-2" align="center">
           <p>nombre <%= carr.getNombre()%></p>           
        </div>
        

<div>
<from>
<input type="number" name="precio" placeholder="$$$" style="padding-right: 5px; width: 109px;  margin-right:10px; margin-left:10px; ">
</from>
</div>
 ...
 <div class="btn-group-vertical" style="margin-right: 50px">
                ...
                <input class="btn btn-success" type="submit" name="Subir" id="boton">
